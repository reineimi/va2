...
#va2tableWrap textarea { all: unset; z-index: 990; box-sizing: border-box; border: 0px solid var(--itemFg); transition: 0.2s; background: var(--windowFg); color: var(--fontColorX); position: absolute; top: 0px; left: 0px; padding: 0.6em 0.75em; width: 100%; height: 100%; }
#va2tableWrap textarea:hover,
#va2tableWrap textarea:focus { z-index: 991; transform: scale(1.1); border: 2px solid var(--green); }
