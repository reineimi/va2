...
#va2tableWrap textarea { all: unset; box-sizing: border-box; border: 0px solid var(--itemFg); transition: 0.2s; background: var(--windowFg); color: var(--fontColorX); position: absolute; top: 0px; left: 0px; padding: 0.6em 0.75em; width: 100%; height: 100%; }
