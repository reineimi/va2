...
#va2tableWrap th,
#va2tableWrap td { background: var(--windowFg); border: 1px solid var(--itemFg); white-space: pre; text-align: left; line-height: 1.2; position: relative; padding: 0px 0.75em 0.25em 0.75em; color: inherit; min-width: 12em; height: 3em; transition: transform 0.3s; }
#va2tableWrap th { font-weight: 700; }
#va2tableWrap textarea { all: unset; z-index: 990; text-wrap: wrap; word-break: break-word; box-sizing: border-box; border: 0px solid var(--itemFg); background: var(--windowFg); color: var(--fontColorX); position: absolute; top: 0px; left: 0px; padding: 0px 0.75em 0.25em 0.75em; width: 100%; height: 100%; transform-origin: 0% 0%; transition: 0.2s; }
#va2tableWrap textarea:hover,
#va2tableWrap textarea:focus { z-index: 991; padding-top: 0px; transform: scale(1.05); border: 2px solid var(--green); }
#va2tableWrap textarea:focus { transform: scale(1.35); text-wrap: unset; word-break: unset; }
