...
#va2tableWrap th,
#va2tableWrap td { background: var(--windowFg); border: 1px solid var(--itemFg); white-space: pre; text-align: left; position: relative; padding: 0.6em 0.75em; color: inherit; width: 16em; min-height: 3em; }
...
#va2tableWrap .va2rowSel { transition: transform 0.3s; transform: scale(0.9) translateX(2rem); }
