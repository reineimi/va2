...
// Load styles
extern.css(`
#va2tableWrap { display: flex; flex-wrap; font-size: 24px; position: relative; width: 95%; height: calc(var(--dvh) * 0.9); margin: auto; padding-top: 6em; overflow: scroll; }
...
#va2tableWrap textarea { all: unset; background: var(--windowBg); position: absolute; top: -2px; left: 0px; padding: 0.6em 0.75em; width: 100%; height: 100%; }
...
#va2tableEditor button { background: none; font: inherit; font-weight: 600; cursor: pointer; padding: 0.5em 0.75em; border: 4px solid #0000; border-radius: 1em; }
