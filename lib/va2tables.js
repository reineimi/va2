...
#va2tableWrap tr { display: flex; position: relative; margin: 0px; overflow: visible; transition: transform 0.3s; animation: appearFromRB 0.5s; }
#va2tableWrap th,
...
#va2tableWrap textarea { all: unset; z-index: 990; text-wrap: wrap; word-break: break-word; box-sizing: border-box; border: 0px solid var(--itemFg); background: var(--windowFg); color: var(--fontColorX); position: absolute; top: 0px; left: 0px; padding: 0.6em 0.75em; width: 100%; height: 100%; transform-origin: 0% 0%; transition: 0.2s; }
#va2tableWrap textarea:hover,
#va2tableWrap textarea:focus { z-index: 991; transform: scale(1.05); border: 2px solid var(--green); }
#va2tableWrap textarea:focus { transform: scale(1.5); text-wrap: unset; word-break: unset; }

#va2tableWrap .va2rowSel { transform: scale(0.9) translateX(2rem); }

#va2tableCleanup { display: table; min-width: 2.5em; margin: 0px 0.5rem 0px 0px; padding-top: 1px; }
...
#va2tableEditor { display: table; position: absolute; top: 0px; left: 0px; white-space: nowrap; padding: 1em 2em; margin: 0px 0px 3em 0px; background: var(--windowFg); border: 1px solid var(--itemFg); border-radius: 2em; }
