...
va2.mod.box = {
	...
	*/
		...
		['Source'],
		['Content'],
		['Box type', {info:'Alternatively, "display" attribute. Different types has different content arrangement methods.'}],
...
<p class='fs1-3 c'>Minimum:</p>
<p>Button <x class='btn px1 py0 borderFg br05'>M</x> stands for "Minimum" and sets the minimum required width/height.</p>
