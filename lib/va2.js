...
"use strict";
const va2 = {
	ver: '1.72.63.191', // rebase(major) . changes(minor) . additions . fixes
	verTips: [
...
va2.mod.temp.init = ()=>{
	...
	#va2ctxtMenu p { border-radius: 0.5rem; background: var(--itemBg); margin: 0.5rem; padding: 0.5rem 1rem; cursor: pointer; }
	#va2ctxtMenu p:hover { background: var(--itemFg); }
	#va2ctxtMenu hr { margin: 0.5rem 0px; border-color: var(--itemBg); }
	</style>`);

	// Create core elements
	mk(document.body, `
		<div id='va2console' class='hide'></div>
	...
	loop(notifs.nav, (_,em)=>{ mk(emitem('va2ctxtMenu', 0), em); });
