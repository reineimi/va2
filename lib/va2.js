...
"use strict";
const va2 = {
	ver: '1.6.48.168', // (major.minor.fixes.commits)
	verTips: [
...
const notifs = {
	...
	add: function(text, _classes, _action) {
		...
		const _notif = create(0, {
			innerHTML: `<div class='m p2 th_windowFg border round fcx f text ts-hover1 ani-slideFromT ${_classes}'>`+
	...
	clear: function() {
		...
		emi('va2notifs').innerHTML = `<p class="tc">${notifs.clear_texts[rand(notifs.clear_texts.len())]}</p>`;
	}
}
va2.f.dnd = function() {
