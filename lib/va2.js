...
"use strict";
const va2 = {
	ver: '1.71.62.188', // rebase(major) . changes(minor) . additions . fixes
	verTips: [
...
const notifs = {
	...
	init: function() {
		let _meta = qem('meta[name="va2meta"]')[0];
		let mdata = {};
...
// ex: <p class'EN'>(hidden)</p> <p onclick='language("EN")'>show .EN</p>
function language(lang_short) {
