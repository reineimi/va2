...
"use strict";
const va2 = {
	ver: '1.7.52.171', // (major.minor.fixes.commits)
	verTips: [
	...
	env: { // "Global environment"
		init: [],
		v: {}, // Storage for vars
		verbose: true, // Prints and on-screen notifications for a lot of things
	},
...
const notifs = {
	...
	clear: function() {
		...
		emi('va2notifs').innerHTML = `<p class="tc fcx">${notifs.clear_texts[rand(notifs.clear_texts.len())]}</p>`;
	}
}
va2.f.dnd = function() {
