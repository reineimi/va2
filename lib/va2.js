...
"use strict";
const va2 = {
	ver: '1.5.44.162', // (major.minor.fixes.commits)
	verTips: [
		...
		"Va2 info: There has been new fixes/improvements in the library. You can take a look at them here: https://github.com/reineimi/va2"
	],
	verTipsStyle: 'color: #fb9; background: #321; padding: 0.5rem 1rem; border-radius: 1rem',
	env: { // "Global environment"
		init: [],
		v: {}, // Storage for vars
		verbose: true, // print() with on-screen notifications
	},
	mod: {}, // Modules
	e: {}, // Storage for enums
...
function notify(text, _classes, _sec) {
	let sec = _sec || 2 + (text.length * 0.05);
	const id = 'va2notif';
	...
	em.innerHTML = `<div class='m shadow py2 px4 th_windowBg round fcx ${_classes || ""}'>${text}</div>`;
}
